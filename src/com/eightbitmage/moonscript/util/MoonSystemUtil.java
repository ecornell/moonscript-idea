 ...
 *         Date: 03.04.2010
 */
public class MoonSystemUtil {
    private static final Key<ConsoleView> CONSOLE_VIEW_KEY = new Key<ConsoleView>("MoonConsoleView");
    ...
    public static void addStdPaths(@NotNull final GeneralCommandLine cmd, @NotNull final Sdk sdk) {
        ...
        for (final VirtualFile file : files) {
            paths.add(MoonFileUtil.getPathToDisplay(file));
        }
    ...
    final static String toolWindowId = "Moon Console Output";
