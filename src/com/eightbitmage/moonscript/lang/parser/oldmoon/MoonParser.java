...
public class MoonParser implements PsiParser, MoonElementTypes {
    ...
    static Logger log = Logger.getInstance("Moon.parser.MoonParser");
...
//    }
    ...
    private static final int MOONI_MAXCCALLS = 200;
...
//    }
    ...
    private static String MOON_QS(String s) {
        return "'" + s + "'";
    }

    private static String MOON_QL(Object o) {
        return MOON_QS(String.valueOf(o));
    }
...
//    }
    ...
    public MoonParser(Reader stream, int firstByte, String source) {
        this.z = stream;
...
//                    mark.drop();
                    parm.drop();
                    this.syntaxerror("<name> or " + MOON_QL("...") + " expected");
                }
    ...
    void funcargs(ExpDesc f) {
        ...
        if (hasmultret(args.k))
            nparams = FuncState.MOON_MULTRET; /* open call */
        else {
            if (args.k != VVOID)
...
//	}
    ...
    void simpleexp(ExpDesc v) {
        ...
        try {
            if (this.t == NUMBER) {
                ...
                FuncState fs = this.fs;
                this.check_condition(fs.isVararg != 0, "cannot use " + MOON_QL("...")
    ...
    void forstat(int line) {
        ...
        if (this.t == ASSIGN) {
            ...
            this.syntaxerror(MOON_QL("=") + " or " + MOON_QL("in") + " expected");
        }
    ...
    void retstat() {
        ...
        if (block_follow(this.t) || this.t == SEMI)
            ...
            if (hasmultret(e.k)) {
                ...
                first = fs.nactvar;
                nret = FuncState.MOON_MULTRET; /* return all values */
            } else {
...
//            cleanAfterError(builder);
    ...
    public ASTNode parse(IElementType root, PsiBuilder builder) {
        ...
        try {
            ...
            source = name;
            MoonParser lexstate = new MoonParser(z, 0, source);
