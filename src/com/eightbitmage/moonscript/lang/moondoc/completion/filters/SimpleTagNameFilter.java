...
package com.eightbitmage.moonscript.lang.moondoc.completion.filters;
...
public class SimpleTagNameFilter implements ElementFilter {
    public boolean isAcceptable(Object element, PsiElement context) {
        ...
        return node != null && node.getElementType() == MoonDocTokenTypes.LDOC_TAG_NAME &&
               context.getParent() instanceof MoonDocTag;
    }
