...
package com.eightbitmage.moonscript.lang.moondoc.parser.parsing;
...
* @author ilyas
*/
public class MoonDocParsing implements MoonDocElementTypes {
  @NonNls
  ...
  private static boolean timeToEnd(PsiBuilder builder) {
    ...
    private boolean parseTag(PsiBuilder builder) {
        ...
        } else if (builder.getTokenType() instanceof MoonDocTagValueTokenType) {
            builder.advanceLexer();
        }
