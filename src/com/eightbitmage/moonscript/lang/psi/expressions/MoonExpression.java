 ...
 * Time: 11:35:57 PM
 */
public interface MoonExpression extends MoonPsiElement {
    MoonExpression[] EMPTY_ARRAY = new MoonExpression[0];
    
    PsiElement replaceWithExpression(MoonExpression newCall, boolean b);
