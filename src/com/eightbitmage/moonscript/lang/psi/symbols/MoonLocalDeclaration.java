 ...
 * Time: 9:15 PM
 */
public interface MoonLocalDeclaration extends MoonLocal, MoonDeclarationExpression {
    static final MoonLocalDeclaration[] EMPTY_ARRAY = new MoonLocalDeclaration[0];
