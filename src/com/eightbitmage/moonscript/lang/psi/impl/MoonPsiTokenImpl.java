 ...
 * Time: 2:25:07 AM
 */
public class MoonPsiTokenImpl extends LeafPsiElement implements MoonPsiToken {
  public MoonPsiTokenImpl(IElementType type, CharSequence text) {
    super(type, text);
  }
  ...
  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof MoonElementVisitor) {
      ((MoonElementVisitor)visitor).visitLuaToken(this);
    }
    else {
