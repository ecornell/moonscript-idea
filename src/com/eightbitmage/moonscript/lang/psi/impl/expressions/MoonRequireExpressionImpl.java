...
import com.eightbitmage.moonscript.lang.psi.expressions.MoonRequireExpression;
 ...
 * Time: 11:19 AM
 */
public class MoonRequireExpressionImpl extends MoonFunctionCallExpressionImpl implements MoonRequireExpression, MoonReferenceElement {
    public MoonRequireExpressionImpl(ASTNode node) {
        super(node);
    }
   ...
   @Override
    public String getName() {
        ...
        return MoonStringLiteralExpressionImpl.stripQuotes(e.getText());
    }
    ...
    public PsiElement getElement() {
        MoonExpressionList argumentList = getArgumentList();

        if (argumentList == null) return null;

        return  argumentList.getMoonExpressions().get(0);
    }
    ...
    public TextRange getRangeInElement() {
        ...
        if (e instanceof MoonStringLiteralExpressionImpl) {
            MoonStringLiteralExpressionImpl moduleNameElement = (MoonStringLiteralExpressionImpl) e;
