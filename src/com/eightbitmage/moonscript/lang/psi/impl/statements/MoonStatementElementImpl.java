 ...
 * Time: 10:16:22 PM
 */
public abstract class MoonStatementElementImpl extends MoonPsiElementImpl implements MoonStatementElement {
    public MoonStatementElementImpl(ASTNode node) {
        super(node);
    }
    ...
    public void accept(@NotNull PsiElementVisitor visitor) {
        if (visitor instanceof MoonElementVisitor) {
            ((MoonElementVisitor) visitor).visitStatement(this);
        } else {
    ...
    @Override
    public MoonStatementElement replaceWithStatement(MoonStatementElement newCall) {
        return (MoonStatementElement) MoonPsiUtils.replaceElement(this, newCall);
    }
}
