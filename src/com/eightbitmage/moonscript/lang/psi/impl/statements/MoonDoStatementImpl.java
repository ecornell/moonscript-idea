...
import com.eightbitmage.moonscript.lang.psi.statements.MoonDoStatement;
 ...
 * Time: 10:40:55 AM
 */
public class MoonDoStatementImpl extends MoonStatementElementImpl implements MoonDoStatement {

    public MoonDoStatementImpl(ASTNode node) {
        super(node);
    }
    ...
    public void accept(@NotNull PsiElementVisitor visitor) {
        if (visitor instanceof MoonElementVisitor) {
            ((MoonElementVisitor) visitor).visitDoStatement(this);
        } else {
