...
import com.eightbitmage.moonscript.lang.psi.statements.MoonRepeatStatement;
 ...
 * Time: 10:40:55 AM
 */
public class MoonRepeatStatementImpl extends MoonStatementElementImpl implements MoonRepeatStatement {

    public MoonRepeatStatementImpl(ASTNode node) {
        super(node);
    }
    ...
    public void accept(@NotNull PsiElementVisitor visitor) {
        if (visitor instanceof MoonElementVisitor) {
            ((MoonElementVisitor) visitor).visitRepeatStatement(this);
        } else {
    ...
    @Override
    public PsiMoonToken getRepeatKeyword() {
        return null;// findChildrenByType(MoonElementTypes.REPEAT);
    }
