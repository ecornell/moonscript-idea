...
import com.eightbitmage.moonscript.lang.formatter.models.spacing.SpacingTokens;
 ...
 * @author ilyas
 */
public abstract class MoonSpacingProcessorBasic extends SpacingTokens implements MoonElementTypes {
...
//                ( leftNode.getPsi().getContext() instanceof MoonGenericForStatement ||
//                        leftNode.getPsi().getContext() instanceof MoonNumericForStatement))
//            return NO_SPACING;
        ...
        if (rightNode.getPsi().getContext() instanceof MoonTableConstructor) {
            if (leftNode.getElementType() == LCURLY) {
                MoonTableConstructor tc = (MoonTableConstructor) rightNode.getPsi().getContext();
