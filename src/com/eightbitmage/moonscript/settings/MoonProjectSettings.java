...
public class MoonProjectSettings implements PersistentStateComponent<MoonProjectSettings> {
    ...
    public MoonProjectSettings getState() {
        return this;
    }

    public void loadState(MoonProjectSettings state) {
         XmlSerializerUtil.copyBean(state, this);
    }

    public static MoonProjectSettings getInstance() {
        return ServiceManager.getService(MoonProjectSettings.class);
    }
}
