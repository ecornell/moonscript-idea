...
public class MoonRunConfiguration extends ModuleBasedConfiguration<RunConfigurationModule> implements CommonLuaRunConfigurationParams, MoonRunConfigurationParams {
    ...
    public MoonRunConfiguration(RunConfigurationModule runConfigurationModule, ConfigurationFactory configurationFactory, String name) {
        super(name, runConfigurationModule, configurationFactory);
    }

    public SettingsEditor<? extends RunConfiguration> getConfigurationEditor() {
        return new MoonRunConfigurationEditor(this);
    }


    public RunProfileState getState(@NotNull final Executor executor, @NotNull final ExecutionEnvironment env) throws ExecutionException {
        MoonCommandLineState state;
        if (isUsingInternalInterpreter())
            ...
            state = new MoonDebugCommandlineState(this, env);
        else
            state = new MoonCommandLineState(this, env);

        TextConsoleBuilder textConsoleBuilder = new MoonTextConsoleBuilder(getProject());
        textConsoleBuilder.addFilter(new MoonLineErrorFilter(getProject()));
    ...
    public static void copyParams(MoonRunConfigurationParams from, MoonRunConfigurationParams to) {
    ...
    protected ModuleBasedConfiguration createInstance() {
        return new MoonRunConfiguration(getConfigurationModule(), getFactory(), getName());
    }
