 ...
 */
public class MoonCommandLineState extends CommandLineState {
    private final MoonRunConfiguration runConfiguration;

    public MoonCommandLineState(MoonRunConfiguration runConfiguration, ExecutionEnvironment env) {
        super(env);
    ...
    protected MoonRunConfiguration getRunConfiguration() {
