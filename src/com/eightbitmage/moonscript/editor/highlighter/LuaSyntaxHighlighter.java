...
public class LuaSyntaxHighlighter extends SyntaxHighlighterBase {
    ...
    public LuaSyntaxHighlighter() {
        ...
        fillMap(colors, LuaTokenTypes.KEYWORDS, LuaHighlightingData.KEYWORD);
        fillMap(colors, LuaTokenTypes.PARENS, LuaHighlightingData.PARENTHS);
        fillMap(colors, LuaTokenTypes.BRACES, LuaHighlightingData.BRACES);
        fillMap(colors, LuaTokenTypes.BRACKS, LuaHighlightingData.BRACKETS);

        fillMap(colors, LuaTokenTypes.BAD_INPUT, LuaHighlightingData.BAD_CHARACTER);
        fillMap(colors, LuaTokenTypes.DEFINED_CONSTANTS, LuaHighlightingData.DEFINED_CONSTANTS);
