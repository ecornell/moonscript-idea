 ...
 */
abstract class NewMoonActionBase extends CreateElementActionBase {
    private static final Logger log = Logger.getInstance("#NewActionBase");

    public NewMoonActionBase(String text, String description, Icon icon) {
    ...
    protected static PsiFile createFileFromTemplate(final PsiDirectory directory,
        ...
        final String ext = "." + MoonFileType.DEFAULT_EXTENSION;
        String filename = (className.endsWith(ext)) ? className : className + ext;
        return MoonTemplatesFactory.createFromTemplate(directory, className, filename, templateName, parameters);
    }
    ...
    public static void checkCreateFile(@NotNull PsiDirectory directory, String name) throws IncorrectOperationException {
        final String fileName = name + "." + MoonFileType.DEFAULT_EXTENSION;
